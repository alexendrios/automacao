...
@logout
@autorizar_ad_autoridade_superior
Cenario: Deacordo com o número gerado da OMP/OS gostaria de autorizar pela autoridade Superior visto que o fluxo da autorização pela Autoridade Determinatne foi realizado 
