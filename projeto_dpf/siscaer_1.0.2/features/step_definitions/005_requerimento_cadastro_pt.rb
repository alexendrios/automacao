Quando("eu estou no formulario Registro para Credenciamento e insiro os seguintes dados: tipo credencial {string} aeroporto {string} atividade {string} descrição atividade {string} cnpj {string} razão social {string} nome fantasia {string} telefone {string}  contato {string} orgão {string} nome completo {string} nome da mae {string} nome do pai {string} sexo {string} data de nascimento {string} nacionalidade {string} uf de nascimento {string} cidade de nascimento {string} cpf {string} documento identificacao {string} orgão expedidor {string} uf documento de identificacao {string} pais {string} cep {string} numero {string} referência nome {string} referência telefone {string} vinculo {string} residente Brasil {string} passaporte {string} tempo residente {string}") do |tipo_credencial, 
