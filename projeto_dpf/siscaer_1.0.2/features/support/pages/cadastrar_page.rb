class Cadastrar < SitePrism::Page
    ...
    element :nova_ocorrencia_button, '#novaOcorrencia'
    ...
    def adicionar_nova_ocorrencia
        click_button 'novaOcorrencia'
    end
...
=end
    ...
    def data_ocorrencia(data)
        dat_ocorrencia.click
        dat_ocorrencia.set data
        find('div.form-row:nth-child(4) > label:nth-child(1)').click
