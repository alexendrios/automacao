class Visualizar < SitePrism::Page
    ...
    def ver_dados_ocorrencia
        @pesquisar.lista[5].click_button 'pfTableselect0'
    end

    #Método ação: Edição
    def editar_dados
        @pesquisar.lista[4].click_button 'pfTableedit0'
    end

=begin
    Método em desuso, mudaram a regra do negócio
=end
